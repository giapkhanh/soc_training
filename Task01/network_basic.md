...
```
1. Kết quả nslookup google.com:
Server:  UnKnown
Address:  fe80::1   <-- [DNS Server IP]

Non-authoritative answer:
Name:    google.com
Addresses:  2404:6800:4005:826::200e  <-- [IPv6 của Google]
          142.250.197.110            <-- [IPv4 của Google]
```

```cmd
2. Kết quả ping -n 2 google.com:
Pinging google.com [142.250.198.142] with 32 bytes of data:
Reply from 142.250.198.142: bytes=32 time=29ms TTL=115
Reply from 142.250.198.142: bytes=32 time=26ms TTL=115

Ping statistics for 142.250.198.142:
    Packets: Sent = 2, Received = 2, Lost = 0 (0% loss),
Approximate round trip times in milli-seconds:
    Minimum = 26ms, Maximum = 29ms, Average = 27ms

-> IP Google nhận diện qua ICMP: 142.250.198.142 (IPv4 Public)
-> RTT trung bình: 27ms
```
